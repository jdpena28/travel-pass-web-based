...
<fragment>
  <section id="Devpage" class="h-[110%] w-full bg-cover z-10">
    <NavigationBar />
    <div
      class="flex absolute w-full justify-center bg-stone-900/50 mx-auto pt-20 pb-[27rem]">
        ...
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div
            ...
            <p class="leading-relaxed text-sm text-center ">
              Your time is limited, so dont waste it living someone elses
              life. Dont be trapped by dogma which is living with the results
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
      <span class="ml-3 text-xl">1BATAAN</span>
    </a>
    <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© Grp2 1Bataan Project —
      <a href="https://github.com/jdpena28/travel-pass-web-based" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@jdpena28</a>
    </p>
